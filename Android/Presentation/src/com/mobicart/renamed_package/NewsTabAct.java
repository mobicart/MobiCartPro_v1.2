...
/**
 * This activity class is for the News tab section which host news feed and
 * twitter feeds.
 * 
 * @author mobicart
 * 
...
public class NewsTabAct extends Activity implements OnCheckedChangeListener,
	...
	/**
	 * This method is used for getting list of news and binding it with view
	 * controls.
	 */
	private void newsListBind() {
		GetNewsTask newsTask = new GetNewsTask(this.getParent(), newsLV,
				radioGroup, headerIV, headerTitle);
		newsTask.execute("");
	}
	...
	private void initializeControls() {
		...
		headerTitle.setText(MobicartCommonData.keyValues.getString(
				"key.iphone.news.news", "News"));
		newsBtn.setText(MobicartCommonData.keyValues.getString(
				"key.iphone.news.news", "News"));
		tweetBtn.setText(MobicartCommonData.keyValues.getString(
				"key.iphone.news.twitter", "Twitter"));
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (radioGroup.getCheckedRadioButtonId() == newsBtn.getId()) {
			...
			if (MobicartCommonData.newsList.get(0).getsType()
