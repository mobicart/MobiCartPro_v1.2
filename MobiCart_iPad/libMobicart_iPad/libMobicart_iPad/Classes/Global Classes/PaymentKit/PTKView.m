...
- (void)setup {
	...
	// 06/11/2014 Tuyen new code for iPad
...
- (void)setupPlaceholderView {
	...
	self.placeholderView.image = [UIImage imageNamed:@"placeholderCard"];
...
- (void)stateCardNumber {
	if (!_isInitialState) {
		...
		[UIView animateWithDuration:0.400
		    ...
		    // 06/11/2014 Tuyen code code for iPad
		    /*
...
- (void)stateMeta {
	...
	// 06/11/2014 Tuyen code for iPad
	/*
...
- (void)setPlaceholderToCardType {
	PTKCardNumber *cardNumber = [PTKCardNumber cardNumberWithString:self.cardNumberField.text];
	PTKCardType cardType = [cardNumber cardType];
	NSString *cardTypeName = @"placeholderCard";
